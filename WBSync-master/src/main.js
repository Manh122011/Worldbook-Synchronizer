...
const MODULE_NAME = "đồng bộ hóa sách thế giới";
...
async function init() {
  try {
    ...
    console.log(`[${MODULE_NAME}] Quá trình khởi tạo đã hoàn tất`);
  } catch (e) {
    console.error(`[${MODULE_NAME}] Khởi tạo không thành công:`, e);
  }
}
